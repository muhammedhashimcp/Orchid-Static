...
const Brochure = () => {
  return (
    ...
    <div className='mt-6 text-xl ml-5 mr-5 md:ml-20 md:mr-20 md:px-40 p-4 text-justify'>
        ...
        <p> Orchid Nirvana 2.0 is new upcoming plotted development project located very much 
            next to Bangalore International Airport Road,Devanahlli,Bangalore with all the world class amenities
             </p>
             <button
              type="submit"
